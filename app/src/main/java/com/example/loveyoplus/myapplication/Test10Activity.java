...
public class Test10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ImageView tempiv =  new ImageView(Test10Activity.this);
    ...
    private Runnable startCountdowntimer = new Runnable() {
        public void run() {
            ...
            rl1.addView(new ImageView(Test10Activity.this));
            //rl1.addView(tempiv);
            new CountDownTimer(5000, 100) {
                ...
                public void onFinish() {
                    ...
                    for(int i=0;i<23;i++){
                        ...
                        rl[i].setOnClickListener(Test10Activity.this);
                    }
    ...
    private Runnable soundtimer = new Runnable() {
        public void run() {
            new CountDownTimer(GAMETIME, 4000) {
                ...
                public void onFinish() {
                    fileStorage fs = new fileStorage();
                    dataList.setInitial(ID.split("_")[0],startDateandTime,"10",(GAMETIME/1000)+"",result[1]+"",result[0]+"",soundResult[1]+"",soundResult[0]+"");
                    ...
                    intent.setClass(Test10Activity.this, FinishActivity.class);
